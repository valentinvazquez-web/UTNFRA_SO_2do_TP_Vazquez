...
cp $HOME/.bash_history ~/UTNFRA_SO_2do_TP_Vazquez/.bash_history
ls -l ~/UTNFRA_SO_2do_TP_Vazquez/
ls -la ~/UTNFRA_SO_2do_TP_Vazquez/
cd ~/UTNFRA_SO_2do_TP_Vazquez/
git add .bash_history 202406/ RTA_Examen_20251118/
git commit -m "Subo 2do parcial: 202406, RTA más reciente y .bash_history"
git push origin main
ls -l 202406/
git add 202406/ RTA_Examen_20251118/ .bash_history
git commit -m "subo todo"
ls -l 202406/ansible/
mv 202406/ansible/README.md .
ls -l
cd ~/UTNFRA_SO_2do_TP_Vazquez/
git add README.md
git commit -m "Muevo README.md de ansible a la raíz del repo debajo de 202406"
git push origin main
mv vazquezAltaUser-Groups.sh RTA_Examen_20251118/
ls -l RTA_Examen_20251118/
git add RTA_Examen_20251118/vazquezAltaUser-Groups.sh
git commit -m "Muevo vazquezAltaUser-Groups.sh a RTA_Examen_20251118"
git push origin main
ls -l RTA_Examen_20251118/
git rm vazquezAltaUser-Groups.sh
git commit -m "Muevo vazquezAltaUser-Groups.sh a RTA_Examen_20251118 y lo saco de la raíz"
git push origin main
history -a
ls -l
ls -l 202406/
ls -l RTA_Examen_$(date +%Y%m%d)/
git add 202406/
git add RTA_Examen_$(date +%Y%m%d)/
git add .bash_history
git add README.md
